...
class PostSurvey(BaseForm):
    ...
    attention_check = RadioField(choices=[("False", 'They must be answerable from content in the image'), ("True", 'They must not be answerable from content in the image')], validators=[DataRequired()])
